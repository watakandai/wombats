...
class TracesGenerator():
    ...
    def __init__(self,
        ...
        of multiple datasets, and export to the output_directory

        :param specification:       A PDFA specification
        :param output_directory:    An output directory
        """
        # private variables
    ...
    def choose_subset_from_samples(self,
        ...
        randomly or in order, and further splits the subset
        into training set and test set.
        (I think the features need to be separated)

        :param traces:              A list of traces
        :param trace_lengths:       A list of trace lengths
        :param trace_probs:         A list of trace probabilities
        :param num_samples:         A number of samples to select
        :param select_method:       Random or in order
        :param test_size:           A size of test set between [0, 1]

        :return:                    A subset of traces, trace_lengths,
                                    and trace_probs
        """
        # check errors
    ...
    def select_datasets(self, param_grid: Dict[str, Any], **kwargs) -> pd.DataFrame:
        """
        Given a list of possible parameters,
        this function loops over those possible combinations,
        and returns a nested list in the same
